...
def download_data(month_listings):
    if month_listings == 'Mar20_listings':
        Airbnb_Mar_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2020-03-19/visualisations/listings.csv'
        Airbnb_Mar_listings_req = requests.get(Airbnb_Mar_listings_url, timeout=30)
        ...
        Airbnb_Mar_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-03-15/visualisations/listings.csv'
        Airbnb_Mar_listings_req = requests.get(Airbnb_Mar_listings_url, timeout=30)
        Airbnb_Mar_listings_url_content = Airbnb_Mar_listings_req.content
        # save the data content in a csv file
        ...
        Airbnb_Apr_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2020-04-25/visualisations/listings.csv'
        Airbnb_Apr_listings_req = requests.get(Airbnb_Apr_listings_url, timeout=30)
        ...
        Airbnb_Mai_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2020-05-24/visualisations/listings.csv'
        Airbnb_Mai_listings_req = requests.get(Airbnb_Mai_listings_url, timeout=30)
        ...
        Airbnb_Mai_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-05-22/visualisations/listings.csv'
        Airbnb_Mai_listings_req = requests.get(Airbnb_Mai_listings_url, timeout=30)
        Airbnb_Mai_listings_url_content = Airbnb_Mai_listings_req.content
        # save the data content in a csv file
        ...
        Airbnb_Jun_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2020-06-20/visualisations/listings.csv'
        Airbnb_Jun_listings_req = requests.get(Airbnb_Jun_listings_url, timeout=30)
        ...
        Airbnb_Jun_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-06-24/visualisations/listings.csv'
        Airbnb_Jun_listings_req = requests.get(Airbnb_Jun_listings_url, timeout=30)
        Airbnb_Jun_listings_url_content = Airbnb_Jun_listings_req.content
        # save the data content in a csv file
        ...
        Airbnb_July_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-07-16/visualisations/listings.csv'
        Airbnb_July_listings_req = requests.get(Airbnb_July_listings_url, timeout=30)
        ...
        Airbnb_Aug_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-08-24/visualisations/listings.csv'
        Airbnb_Aug_listings_req = requests.get(Airbnb_Aug_listings_url, timeout=30)
        ...
        Airbnb_Sep_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-09-24/visualisations/listings.csv'
        Airbnb_Sep_listings_req = requests.get(Airbnb_Sep_listings_url, timeout=30)
        ...
        Airbnb_Oct_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-10-20/visualisations/listings.csv'
        Airbnb_Oct_listings_req = requests.get(Airbnb_Oct_listings_url, timeout=30)
        ...
        Airbnb_Nov_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-11-25/visualisations/listings.csv'
        Airbnb_Nov_listings_req = requests.get(Airbnb_Nov_listings_url, timeout=30)
        ...
        Airbnb_Dec_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2019-12-26/visualisations/listings.csv'
        Airbnb_Dec_listings_req = requests.get(Airbnb_Dec_listings_url, timeout=30)
        ...
        Airbnb_Jan_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2020-01-22/visualisations/listings.csv'
        Airbnb_Jan_listings_req = requests.get(Airbnb_Jan_listings_url, timeout=30)
        ...
        Airbnb_Feb_listings_url = 'https://data.insideairbnb.com/germany/bv/munich/2020-02-27/visualisations/listings.csv'
        Airbnb_Feb_listings_req = requests.get(Airbnb_Feb_listings_url, timeout=30)
